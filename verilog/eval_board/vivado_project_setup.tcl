# This is an adapted version of the Xillydemo setup script from
# xillinux-eval-microzed-2.0c.zip.  It sets up things for the Xillybus
# IP on the MicroZed.
...
# ram: not sure what this is doing, making it a string same as the
# project name, as it is for xillydemo.
set_property "top" "eval_board" $obj
...
add_files -fileset $obj -norecurse $origin_dir/eval_board.xdc
